...
| [MCP-02](ISSUE_MCP-02_mcpb_bundle_distribuible.md) | Bundle .mcpb distribuible del servidor MCP — un solo asset para cualquier usuario | P1 | DONE | MCP-01, SETUP-01, SETUP-02 |

**13/13 tickets `DONE` — 105/105 tests pasan.**
